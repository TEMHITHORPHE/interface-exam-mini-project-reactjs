            ...
            <div className="App-card">
              ...
              <div className="App-card-content">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      handle={aumCount + longCount + 2000}
                      position="right-bottom"
                      renderContent={() => (
                  ...
                  <div className="App-card-row">
                    ...
                    <div>
                      <TooltipComponent
                        position="right-bottom"
                        className="nowrap"
                        handle={(longCount + aumCount + 23) / 0.3}
                        renderContent={() => (
                          <TooltipCard
                            title={t`Fees`}
                  ...
                  {gmxDistributionData.length > 0 && (
                    <div className="stats-piechart" onMouseLeave={onGMXDistributionChartLeave}>
                      <div className="stats-piechart-title">
                        ...
                        <div className="stats-piechart-distribution-percentage">{`${stakedPercent}%`}</div>
                      </div>
                    </div>
                  )}
                </div>
