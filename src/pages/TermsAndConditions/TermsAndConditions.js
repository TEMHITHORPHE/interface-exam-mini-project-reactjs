      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">W.A.X</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                and conditions by which you may access WAX.io ("the Site") and app.WAX.io ("the
            ...
            <div className="section">
              ...
              <p className="body-text">The WAX.io site is for informational purposes only.</p>
              <p className="body-text">
                WAX.io is not part of any transaction on the blockchain networks underlying the W.A.X
                ...
                store, send, or receive any crypto assets. You understand that when you interact with any W.A.X
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over WAX.io or you as otherwise duly
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that WAX.io or any of its suppliers or contractors may undertake
                        from time to time; (c) causes beyond WAX.io's control or that WAX.io could not
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with WAX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. WAX.io does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. WAX.io does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. WAX.io own all rights, names, logos, and other marks used on the Site and the
                    ...
                    the W.A.X Protocol and the Interface (app.WAX.io) deployed on IPFS is open-sourced.
                ...
                <li>
                  <p className="body-text">
                    4.2. WAX.io may use and share your comments, bug reports, ideas, or other feedback that you
                    may provide, including suggestions about how we might improve. You agree that WAX.io is
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. WAX.io reserve the right, at our sole discretion, from time to time and with or
                    ...
                    do not host or own its code. WAX.io will not be liable for any losses suffered by you
                ...
                <li>
                  <p className="body-text">
                    5.2. WAX.io may revise these Terms from time to time. We will notify you by updating the
                    date at the top of the Terms and maintaining a current version. The most current version of the
                    Terms will always be at https://WAX.io/#/terms-and-conditions. All modifications will be
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. WAX.io does not
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That WAX.io is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither WAX.io nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. WAX.io is not responsible for the content of any third party, including, but not
                    limited to, information, materials, products, or services that WAX.io does not own or
                    control. In addition, third parties may offer promotions related to your access and use of the
                    Interface. WAX.io does not endorse or assume any responsibility for such resources or
                    ...
                    relationships with any third parties. You expressly relieve WAX.io of all liability arising
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that WAX.io will have no responsibility or liability for
                    the risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether
                    known or unknown to you, against WAX.io, its affiliates, and their respective shareholders,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of WAX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including WAX.io's collaborator
            ...
            <div className="section">
              ...
              <p className="body-text">
                WAX.io is an informational site for the W.A.X Protocol. WAX.io does not operate
              ...
              <p className="body-text">
                You understand that WAX.io is not registered or licensed by any regulatory agency or authority.
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall WAX.io, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of WAX.io, whether under contract,
                ...
                Terms or any limited remedy hereunder nor is WAX.io in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall WAX.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                WAX.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to WAX.io on any of our official channels. The notice must (a) describe the
                nature and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be
                similar in form to that described above. If you and WAX.io cannot reach an agreement to resolve
                the claim within sixty (60) days of your email, then you and WAX.io agree to resolve the
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of WAX.io set forth in these Terms is in addition to, and not in
                    lieu of, any other right or remedy whether described in these Terms, under Applicable Law, at law,
                    or in equity. The failure or delay of WAX.io in exercising any right, power, or privilege
                ...
                <li>
                  <p className="body-text">
                    13.4. WAX.io will have no responsibility or liability for any failure or delay in
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and WAX.io and supersede all
