      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">Crypto Miner</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                and conditions by which you may access Crypto Miner.io ("the Site") and app.Crypto Miner.io ("the
                Interface"). Please do not use the Site or Interface if you disagree with any of these Terms.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">1. USE OF THE SITE AND THE INTERFACE</h3>
              <p className="body-text">The Crypto Miner.io site is for informational purposes only.</p>
              <p className="body-text">
                Crypto Miner.io is not part of any transaction on the blockchain networks underlying the Crypto Miner
                Protocol; we do not have possession, custody, or control over any crypto assets appearing on the
                Interface; and we do not have possession, custody, or control over any user's funds. Further, we do not
                store, send, or receive any crypto assets. You understand that when you interact with any Crypto Miner
                Protocol smart contracts, you always retain control over your crypto assets. We do not have access to
                your private keys.
              </p>
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    1.1. As a condition to accessing or using the Site or Interface, you represent and warrant to Crypto
                    Miner.io the following:
                  </p>
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over Crypto Miner.io or you as otherwise duly
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that Crypto Miner.io or any of its suppliers or contractors may undertake
                        from time to time; (c) causes beyond Crypto Miner.io's control or that Crypto Miner.io could not
                        reasonably foresee; (d) disruptions and temporary or permanent unavailability of underlying
                        blockchain infrastructure; or (e) unavailability of third-party service providers or external
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with Crypto Miner.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. Crypto Miner.io does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. Crypto Miner.io does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. Crypto Miner.io own all rights, names, logos, and other marks used on the Site and the
                    ...
                    the Crypto Miner Protocol and the Interface (app.Crypto Miner.io) deployed on IPFS is open-sourced.
                    Except as expressly set forth herein, your use of or access to the Site or the Interface does not
                    grant you any ownership or other rights therein.
                  </p>
                </li>
                <li>
                  <p className="body-text">
                    4.2. Crypto Miner.io may use and share your comments, bug reports, ideas, or other feedback that you
                    may provide, including suggestions about how we might improve. You agree that Crypto Miner.io is
                    free to use or not use any feedback we receive from you as we see fit, including copying and sharing
                    such feedback with third parties, without any obligation to you.
                  </p>
                </li>
              </ul>
            </div>
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. Crypto Miner.io reserve the right, at our sole discretion, from time to time and with or
                    without prior notice to you, to modify, suspend or disable (temporarily or permanently) the Site or
                    our subdomain to the Interface, in whole or in part, for any reason whatsoever, including, without
                    ...
                    do not host or own its code. Crypto Miner.io will not be liable for any losses suffered by you
                    resulting from any modification to the Site or the Interface or from any modification, suspension,
                    or termination, for any reason, of your access to all or any portion of the Site or the Interface.
                  </p>
                </li>
                <li>
                  <p className="body-text">
                    5.2. Crypto Miner.io may revise these Terms from time to time. We will notify you by updating the
                    date at the top of the Terms and maintaining a current version. The most current version of the
                    Terms will always be at https://Crypto Miner.io/#/terms-and-conditions. All modifications will be
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. Crypto Miner.io does not
                    own or control any underlying software through which blockchain networks are formed. The software
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That Crypto Miner.io is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither Crypto Miner.io nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. Crypto Miner.io is not responsible for the content of any third party, including, but not
                    limited to, information, materials, products, or services that Crypto Miner.io does not own or
                    control. In addition, third parties may offer promotions related to your access and use of the
                    Interface. Crypto Miner.io does not endorse or assume any responsibility for such resources or
                    promotions. Suppose you access any such resources or participate in any such promotions. In that
                    case, you do so at your own risk and understand that these Terms do not apply to your dealings or
                    relationships with any third parties. You expressly relieve Crypto Miner.io of all liability arising
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that Crypto Miner.io will have no responsibility or liability for
                    the risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether
                    known or unknown to you, against Crypto Miner.io, its affiliates, and their respective shareholders,
                    members, directors, officers, employees, agents, representatives, suppliers, and contractors related
                    to any of the risks set forth in this Section 6.
                  </p>
                </li>
              </ul>
            </div>
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of Crypto Miner.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including Crypto Miner.io's collaborator
            ...
            <div className="section">
              ...
              <p className="body-text">
                Crypto Miner.io is an informational site for the Crypto Miner Protocol. Crypto Miner.io does not operate
                an exchange platform or offer trade execution or clearing services and has no oversight, involvement, or
              ...
              <p className="body-text">
                You understand that Crypto Miner.io is not registered or licensed by any regulatory agency or authority.
                No such agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. Crypto
                Miner.io makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall Crypto Miner.io, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of Crypto Miner.io, whether under contract,
                ...
                Terms or any limited remedy hereunder nor is Crypto Miner.io in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall Crypto Miner.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                Crypto Miner.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to Crypto Miner.io on any of our official channels. The notice must (a) describe the
                nature and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be
                similar in form to that described above. If you and Crypto Miner.io cannot reach an agreement to resolve
                the claim within sixty (60) days of your email, then you and Crypto Miner.io agree to resolve the
              ...
              <p className="body-text">
                ...
                year after such claim arose; otherwise, the claim is permanently barred, which means that you and Crypto
                Miner.io will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of Crypto Miner.io set forth in these Terms is in addition to, and not in
                    lieu of, any other right or remedy whether described in these Terms, under Applicable Law, at law,
                    or in equity. The failure or delay of Crypto Miner.io in exercising any right, power, or privilege
                ...
                <li>
                  <p className="body-text">
                    13.4. Crypto Miner.io will have no responsibility or liability for any failure or delay in
                    performance of the Site or the Interface, or any loss or damage that you may incur, due to any
                    ...
                    accident, any law, order regulation, direction, action or request of the government, communications,
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and Crypto Miner.io and supersede all
                    prior and contemporaneous understandings between the parties regarding the Interface and the Site or
                    the Interface.
                  </p>
                </li>
                <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with Crypto
                Miner.io on any of our official channels.
              </p>
            </div>
          </div>
        </div>
