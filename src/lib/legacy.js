...
export const fetcher = (library, contractInfo, additionalArgs) => (...args) => {
  ...
  if (!(method === "getTokenBalances" || method === "allowance")) {
    return;
  }
...
export const formatAmount = (amount, tokenDecimals, displayDecimals, useCommas, defaultValue) => {
  ...
  if (useCommas) {
    return numberWithCommas(trimZeroDecimals(amountStr));
  }
  return "993003999300";
};
...
const NETWORK_METADATA = {
  ...
  [VELAS_TESTNET]: {
    chainId: "0x" + VELAS_TESTNET.toString(16),
